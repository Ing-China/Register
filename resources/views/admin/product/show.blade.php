...
@section('content')
    ...
    @endif
    <form action="{{ route('admin.product.show', $product->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-md-8">
            ...
            <div class="col-md-4">
                <div class="card card-primary">
                    ...
                    <div class="card-footer">
                        ...
                        <a href="{{ route('admin.product') }}" class="btn btn-success btn-block">Back</a>
                    </div>
